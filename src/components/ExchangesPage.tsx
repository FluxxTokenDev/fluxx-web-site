      ...
      <main className="pt-20">
        <section className="w-full bg-[#0A0A0A] py-24 px-4">
          <div className="container mx-auto max-w-4xl">
            ...
            >
              List Fluxx tokens and tap into high-volume trading opportunities
            </motion.p>
              ...
              {[
                {
                  ...
                  description:
                    "Access deep liquidity pools and high trading volumes",
                },
                {
                ...
                {
                  title: "Market Making",
                  description: "Professional market making services available",
                },
                {
                  title: "Security Features",
                  description:
                    "Advanced security protocols and monitoring tools",
                },
              ].map((feature, index) => (
                <motion.div
                  key={index}
