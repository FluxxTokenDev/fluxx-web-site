      ...
      <main className="pt-20">
        <section className="w-full bg-[#0A0A0A] py-24 px-4">
          <div className="container mx-auto max-w-4xl">
            ...
            >
              Experience borderless shopping and seamless transactions with
              Fluxx
            </motion.p>
              ...
              {[
                {
                  ...
                  description:
                    "Shop from merchants worldwide without currency barriers",
                },
                {
                  title: "Instant Transfers",
                  description:
                    "Send and receive payments instantly with zero fees",
                },
                {
                  title: "Secure Storage",
                  description:
                    "Keep your digital assets safe with our secure wallet",
                },
                {
